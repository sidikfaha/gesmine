		...
		<v-col>
			...
			<v-simple-table dark>
				<template v-slot:default>
					...
					<tr>
						<td>Longueur charge font</td>
						<td>{{ lcf }} m</td>
					</tr>
					<tr>
						<td>Longueur de relance de la charge</td>
						<td>{{ lrc }} m</td>
					</tr>
					<tr>
	...
	export default {
		...
		data() {
			return {
				...
				lcf: 0, // Longueur charge font (m)
				lrc: 0, // Longueur de relance de la charge (m)
